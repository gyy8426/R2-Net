...
class LinearizedContext(nn.Module):
    ...
    def __init__(self, classes, rel_classes, mode='sgdet',
        ...
        post_lstm_dim = obj_gcn_input_dim
        ...
        '''
        post_lstm_in = self.embed_dim + self.hidden_dim
    ...
    def forward(self, obj_fmaps, obj_logits, im_inds, obj_labels=None,
        ...
        edge_sub_ctx = None
        edge_obj_ctx = None
        pred_embed3 = self.obj_embed2(obj_preds_nozeros)
        if self.with_gcn:
            gtc_input = torch.cat([obj_ctx,pred_embed3],-1)
